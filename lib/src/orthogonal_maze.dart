...
//module Theseus
  ...
  OrthogonalMaze(MazeOptions options) : super(options);
    ...
    List<int> potential_exits_at(x, y){ //#:nodoc:
    ...
    Maze to_unicursal(options/*={}*/){
      ...
      set(int x,int y,int direction, [bool recip = false]){ //lambda do |x, y, direction, *recip|
      ...
      if (enter_at!=null && exit_at!=null){
        ...
        if (enter_at.x < exit_at.x){ //enter_at[0] < exit_at[0]
